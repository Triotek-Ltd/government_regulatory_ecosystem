"""Relation service seed for filing_requirement."""
...
RELATED_DOCS = [{'doc_id': 'ecosystem_filing_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'government_report', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'license_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []
