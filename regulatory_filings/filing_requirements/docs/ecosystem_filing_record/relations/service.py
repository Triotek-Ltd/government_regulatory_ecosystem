...
RELATED_DOCS = [{'doc_id': 'filing_requirement', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'regulatory_review_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'regulatory_filing', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'authority'}, {'description': 'due rule'}, {'description': 'obligation context from filing_requirement'}]
