"""Relation service seed for ecosystem_filing_record."""
...
RELATED_DOCS = [{'doc_id': 'filing_requirement', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'regulatory_review_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'regulatory_filing', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'party_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = [{'source_field': 'party', 'doc_id': 'party_record', 'mode': 'context'}]

BORROWED_FIELDS = [{'description': 'authority'}, {'description': 'due rule'}, {'description': 'obligation context from filing_requirement'}, {'field_id': 'party', 'doc_id': 'party_record', 'description': 'Borrow context from party_record through party.'}]
