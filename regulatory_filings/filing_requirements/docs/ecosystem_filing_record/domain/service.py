...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['filing_requirement', 'regulatory_review_case', 'regulatory_filing'], 'action_targets': {'create': None, 'prepare': None, 'submit': 'submitted', 'amend': None, 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
