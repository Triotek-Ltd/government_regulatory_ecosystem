"""Relation service seed for regulatory_review_case."""
...
RELATED_DOCS = [{'doc_id': 'ecosystem_filing_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'report_submission', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'license_renewal_case', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'filing/report'}, {'description': 'authority context from linked docs'}]
