"""Action handler seed for regulatory_review_case:review."""
...
ACTION_ID = "review"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'in_review', 'remediated'], 'transitions_to': 'in_review'}
