"""Action handler seed for regulatory_review_case:create."""
...
ACTION_ID = "create"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'in_review', 'remediated'], 'transitions_to': None}
