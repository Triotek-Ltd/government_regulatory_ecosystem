...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['ecosystem_filing_record', 'report_submission', 'license_renewal_case'], 'action_targets': {'create': None, 'assign': 'in_review', 'review': 'in_review', 'remediate': None, 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
