"""Relation service seed for report_acknowledgement."""
...
RELATED_DOCS = [{'doc_id': 'report_submission', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'government_report', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'submission'}, {'description': 'report context from linked docs'}]
