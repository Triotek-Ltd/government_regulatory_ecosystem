...
CONTRACT = {'title_field': 'title', 'status_field': 'workflow_state', 'reference_field': 'reference_no', 'required_fields': ['title', 'workflow_state', 'posting_date'], 'field_purposes': {'workflow_state': 'lifecycle_state', 'posting_date': 'posting_date', 'received_date': 'schedule_marker', 'acknowledgement_status': 'status_flag'}, 'search_fields': ['title', 'reference_no', 'description', 'acknowledgement_code', 'source_submission', 'external_acknowledgement_reference'], 'list_columns': ['title', 'reference_no', 'posting_date', 'workflow_state'], 'initial_state': 'received', 'lifecycle_states': ['received', 'linked', 'archived'], 'terminal_states': ['archived'], 'action_targets': {'record': None, 'link': None, 'archive': 'archived'}}
