"""Workflow service seed for report_acknowledgement."""
...
STATES = ['received', 'linked', 'archived']
TERMINAL_STATES = ['archived']
ACTION_RULES: dict[str, dict[str, Any]] = {'record': {'allowed_in_states': ['received', 'linked'], 'transitions_to': None}, 'link': {'allowed_in_states': ['received', 'linked'], 'transitions_to': None}, 'archive': {'allowed_in_states': ['received', 'linked'], 'transitions_to': 'archived'}}
