...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['government_report', 'report_acknowledgement', 'regulatory_review_case'], 'action_targets': {'create': None, 'submit': 'submitted', 'retry': None, 'accept': None, 'reject': 'rejected', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
