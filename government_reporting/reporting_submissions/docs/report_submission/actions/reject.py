"""Action handler seed for report_submission:reject."""
...
ACTION_ID = "reject"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'submitted', 'accepted', 'rejected', 'completed'], 'transitions_to': 'rejected'}
