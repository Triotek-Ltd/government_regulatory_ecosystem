"""Action handler seed for report_submission:accept."""
...
ACTION_ID = "accept"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'submitted', 'accepted', 'rejected', 'completed'], 'transitions_to': None}
