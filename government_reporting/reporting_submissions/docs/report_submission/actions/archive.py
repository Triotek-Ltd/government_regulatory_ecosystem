"""Action handler seed for report_submission:archive."""
...
ACTION_ID = "archive"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'submitted', 'accepted', 'rejected', 'completed'], 'transitions_to': 'archived'}
