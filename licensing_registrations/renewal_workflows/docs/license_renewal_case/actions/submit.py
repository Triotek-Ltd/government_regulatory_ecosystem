"""Action handler seed for license_renewal_case:submit."""
...
ACTION_ID = "submit"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'preparing', 'submitted', 'renewed', 'expired'], 'transitions_to': 'submitted'}
