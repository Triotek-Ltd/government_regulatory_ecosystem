"""Action handler seed for license_renewal_case:prepare."""
...
ACTION_ID = "prepare"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'preparing', 'submitted', 'renewed', 'expired'], 'transitions_to': None}
