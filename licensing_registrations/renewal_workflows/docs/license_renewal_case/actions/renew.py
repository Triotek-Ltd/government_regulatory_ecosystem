"""Action handler seed for license_renewal_case:renew."""
...
ACTION_ID = "renew"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'preparing', 'submitted', 'renewed', 'expired'], 'transitions_to': 'renewed'}
