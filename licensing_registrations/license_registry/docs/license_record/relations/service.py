"""Relation service seed for license_record."""
...
RELATED_DOCS = [{'doc_id': 'registration_application', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'license_renewal_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'filing_requirement', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'authority/program context from filing_requirement where linked'}]
