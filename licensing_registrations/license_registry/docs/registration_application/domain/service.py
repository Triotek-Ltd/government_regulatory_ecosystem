...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['license_record', 'license_renewal_case'], 'action_targets': {'create': None, 'submit': 'submitted', 'update': None, 'approve': 'approved', 'reject': 'rejected', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
