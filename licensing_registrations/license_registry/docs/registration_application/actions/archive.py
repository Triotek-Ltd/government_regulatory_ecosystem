"""Action handler seed for registration_application:archive."""
...
ACTION_ID = "archive"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'submitted', 'in_review', 'approved', 'rejected'], 'transitions_to': 'archived'}
