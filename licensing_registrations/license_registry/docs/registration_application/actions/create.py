"""Action handler seed for registration_application:create."""
...
ACTION_ID = "create"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['draft', 'submitted', 'in_review', 'approved', 'rejected'], 'transitions_to': None}
